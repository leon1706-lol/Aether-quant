        ...
        {cards && cards.length > 0 ? (
          cards.map((card) => (
            <div key={card.key} className="rounded-2xl border border-white/5 bg-white/[0.03] p-4">
              <span className="mb-2 block text-[0.72rem] uppercase tracking-widest text-slate-400">
                {card.label}
              </span>
          ...
          <div className="rounded-2xl border border-white/5 bg-white/[0.03] p-4">
            <span className="mb-2 block text-[0.72rem] uppercase tracking-widest text-slate-400">Status</span>
