...
**Severity:** 9/10 · **Status:** 🟡 `root mechanism identified (bar_index ~2x inflation, likely cause of crypto/FX absence) — not yet fixed, exact Lean-level cause not yet traced`
