...
<p align="center">
  ...
  <!-- AQ:TEST_BADGE_START --><img src="https://img.shields.io/badge/tests-2708%2F2708%20passing-brightgreen?style=flat-square&labelColor=1A1A1A" alt="2708 of 2708 tests passing"><!-- AQ:TEST_BADGE_END -->
...
is built, tested (<!-- AQ:TEST_COUNT_START -->2708<!-- AQ:TEST_COUNT_END -->
...
| `tests/` | Pytest suite conventions (<!-- AQ:TEST_COUNT_START -->2708<!-- AQ:TEST_COUNT_END --> tests) | [README](tests/README.md) |
...
_Backtest split, full history. Last updated 2026-08-21 18:35 UTC (auto-generated by `aq evaluate --all`)._
<!-- AQ:EVAL_END -->
...
6 expanding/rolling windows, run `walk-forward-a9cd8cfb-24f0-4963-b80b-8ee299df2613`. Last updated 2026-08-21 18:35 UTC (auto-generated by `aq train --walk-forward`).
<!-- AQ:WALKFORWARD_END -->
...
| Dates reconciled | 56 |
| Exact matches | 0 |
| Mean overlap fraction | 56.88% |
| Mean raw-score delta | 0.0185 |
| Replay mode | replay_hysteresis |

Book-member decision outcomes (672 total, real Lean run):

| Action | Count | Share |
|---|---|---|
| reduce_risk | 375 | 55.8% |
| simulate | 184 | 27.4% |
| trade | 112 | 16.7% |
| observe | 1 | 0.1% |
...
_Last updated 2026-08-21 18:35 UTC (auto-generated by `aq evaluate`)._
...
<!-- AQ:TEST_COUNT_START -->2708<!-- AQ:TEST_COUNT_END --> tests, one file per source module, run via:
