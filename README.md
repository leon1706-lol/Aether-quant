...
| Sharpe Ratio | -2.17 |
| Net Profit | -4.752% |
| Compounding Annual Return | -2.139% |
| Drawdown | 4.800% |
| Total Orders | 644 |
| Win Rate | 28% |
| Last updated | 2026-08-11 13:40 UTC (auto-generated by `aq backtest`) |
<!-- AQ:BACKTEST_END -->
...
| Annual Variance | 0 |
| Information Ratio | -1.031 |
| Tracking Error | 0.199 |
| Treynor Ratio | -1.784 |
| Total Fees | $840.00 |
| Estimated Strategy Capacity | $790000000.00 |
| Lowest Capacity Asset | USDCHF 8G |
