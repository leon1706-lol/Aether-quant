...
| Sharpe Ratio | -1.72 |
| Net Profit | -4.444% |
| Compounding Annual Return | -1.999% |
| Drawdown | 6.500% |
| Total Orders | 476 |
| Win Rate | 22% |
| Last updated | 2026-08-13 16:05 UTC (auto-generated by `aq backtest`) |
<!-- AQ:BACKTEST_END -->
...
|---|---|---|
| Gross Sharpe | 1.363 | 1.551 |
| Net Sharpe | 1.334 | 1.517 |
| Net total return | 8.43% | 11.75% |
| Max drawdown | -3.63% | -3.25% |
| Annualized turnover | 1.36 | 1.88 |
| Cost drag (bps/yr) | 8.1 | 11.3 |
| Capacity (USD) | 4,396,756 | 4,052,643 |

_Backtest split, full history. Last updated 2026-08-13 19:48 UTC (auto-generated by `aq evaluate --all`)._
<!-- AQ:EVAL_END -->
...
| Metric | Value |
|---|---|
| gross_sharpe | 1.3632793663150384 |
| net_sharpe | 1.3335459137374595 |
| gross_total_return | 0.08628242431093591 |
| net_total_return | 0.08430384958553971 |
| net_max_drawdown | -0.036342222120894 |
| annualized_turnover | 1.3553982300884957 |
| cost_drag_annual_bps | 8.132389380530974 |
| num_rebalances | 57 |
| num_dates_used | 565 |
| mean_names_long | 6.0 |
...
|---|---|---|---|
| 1.0x | 1.3633 | 1.3335 | 8.1 |
| 2.0x | 1.3633 | 1.3037 | 16.3 |
| 3.0x | 1.3633 | 1.2738 | 24.4 |

**Sequence model**

| Metric | Value |
|---|---|
| gross_sharpe | 1.550741157419189 |
| net_sharpe | 1.5165199843813586 |
| gross_total_return | 0.1203631962073437 |
| net_total_return | 0.11753229023535261 |
| net_max_drawdown | -0.03252428406549268 |
| annualized_turnover | 1.880973451327434 |
| cost_drag_annual_bps | 11.285840707964601 |
| num_rebalances | 57 |
| num_dates_used | 565 |
| mean_names_long | 6.0 |
| mean_names_short | 6.0 |
...
Capacity: $4,052,643 (binding: BWX)
...
| Cost multiplier | Gross Sharpe | Net Sharpe | Cost drag (bps/yr) |
|---|---|---|---|
| 1.0x | 1.5507 | 1.5165 | 11.3 |
| 2.0x | 1.5507 | 1.4822 | 22.6 |
| 3.0x | 1.5507 | 1.4477 | 33.9 |
...
6 expanding/rolling windows, run `walk-forward-a9cd8cfb-24f0-4963-b80b-8ee299df2613`. Last updated 2026-08-13 19:48 UTC (auto-generated by `aq train --walk-forward`).
<!-- AQ:WALKFORWARD_END -->
...
(see [`development/Problems.md`](development/Problems.md) #90-#95).
...
| Source | Sharpe |
|---|---|
| Real Lean backtest (2019-01-01 to 2021-04-02) | -1.720 |
| Offline evaluation — sequence model (full backtest split) | 1.517 |
| Offline evaluation — multitask model (full backtest split) | 1.334 |
| Walk-forward mean (out-of-sample, per-window) | 0.654 |
| Gap: sequence offline − real Lean | +3.237 |
| Gap: walk-forward − real Lean | +2.374 |

**Book-history reconciliation** (real Lean selections vs. a fresh offline re-derivation of the same dates)

| Metric | Value |
|---|---|
| Dates reconciled | 174 |
| Exact matches | 0 |
| Mean overlap fraction | 24.02% |
| Mean raw-score delta | 0.1193 |
| Replay mode | replay_hysteresis |

Book-member decision outcomes (1464 total, real Lean run):

| Action | Count | Share |
|---|---|---|
| reduce_risk | 870 | 59.4% |
| simulate | 327 | 22.3% |
| trade | 267 | 18.2% |
...
|---|---|---|
| Real Lean backtest (2019-01-01 to 2021-04-02) | 0 | — |
| Offline replay (approximation, see Disclaimer) | 78 | 73.5% |

_Last updated 2026-08-13 19:48 UTC (auto-generated by `aq evaluate`)._
...
- **The kill-switch replay is a known over-estimate.** It models only the
  ...
  a prediction — the real backtest has shown far fewer trips in practice.
